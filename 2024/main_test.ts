...
Deno.test(function problem16Test() {
  const output = Deno.readTextFileSync(`outputs/16.txt`).split("\n").map((x) => Number.parseInt(x));
  assertEquals(problem16a(`inputs/16e.txt`), output[0]);
  assertEquals(problem16a(`inputs/16.txt`), output[1]);
  assertEquals(problem16b(`inputs/16e.txt`), output[2]);
  assertEquals(problem16b(`inputs/16.txt`), output[3]);
});

Deno.test(function problem17Test() {
  const output = Deno.readTextFileSync(`outputs/17.txt`).split("\n");
  assertEquals(problem17a(`inputs/17e.txt`), output[0]);
  assertEquals(problem17a(`inputs/17.txt`), output[1]);
  assertEquals(problem17b(`inputs/17e2.txt`), Number.parseInt(output[2]));
  assertEquals(problem17b(`inputs/17.txt`), Number.parseInt(output[3]));
});

Deno.test(function problem18Test() {
  const output = Deno.readTextFileSync(`outputs/18.txt`).split("\n");
  assertEquals(problem18a(`inputs/18e.txt`), Number.parseInt(output[0]));
...
Deno.test(function problem20Test() {
  const output = Deno.readTextFileSync(`outputs/20.txt`).split("\n");
  assertEquals(problem20a(`inputs/20e.txt`), Number.parseInt(output[0]));
  assertEquals(problem20a(`inputs/20.txt`), Number.parseInt(output[1]));
  assertEquals(problem20b(`inputs/20e.txt`), Number.parseInt(output[2]));
  assertEquals(problem20b(`inputs/20.txt`), Number.parseInt(output[3]));
});