...
Deno.test(function problem08Test() {
  ...
  assertEquals(problem08a(`inputs/08e.txt`, 10), output[0]);
  assertEquals(problem08a(`inputs/08.txt`, 1000), output[1]);
...
Deno.test(function problem11Test() {
  ...
  assertEquals(problem11b(`inputs/11e2.txt`), output[2]);
...
Deno.test(function problem12Test() {
  ...
  assertEquals(problem12b(`inputs/12e2.txt`), output[2]);
